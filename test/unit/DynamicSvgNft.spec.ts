...
import { DynamicSvgNft } from "../../typechain"
import { MockV3Aggregator } from "../../typechain/@chainlink/contracts/src/v0.6/tests"
  ...
  : describe.only("Dynamic SVG NFT Unit Tests", function () {
      ...
      describe("mintNft", () => {
        it("emits an event and creates the NFT", async function () {
          ...
          await expect(
            dynamicSvgNft.mintNft(highValue, {
              value: parseEther("0.1"),
            })
          ).to.emit(dynamicSvgNft, "NftRequest")
